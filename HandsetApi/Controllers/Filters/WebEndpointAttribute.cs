...
{
    public class WebEndpointAttribute : Attribute, IAuthenticationFilter
    {
        ...
        public Task AuthenticateAsync(HttpAuthenticationContext context, CancellationToken cancellationToken)
        {
            ...
            {
                return ChallengeAsync(context, cancellationToken, context.Request);
            }
            return Task.Run(() => { context.Principal = new WebPrincipal(context.Request.Headers.Authorization.Parameter); });
        }
        ...
        {
            context.ErrorResult = new AuthenticationFailureResult("Authentication Required", request);
